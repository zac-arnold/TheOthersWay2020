  ...
  return (
    ...
    <div id='app'>
      ...
      <div className="logo-container">
        <a href="https://twitter.com/FlyingOutMusic" target="blank" rel="noopener noreferrer"><img className="socialmedia" src={Twitlogo} alt="Twitter Logo" /></a>

        <a href="https://www.instagram.com/flyingoutmusic/" target="_blank" rel="noopener noreferrer"><img className="socialmedia" src={instalogo} alt="Instagram Logo" /></a>

        <a href="https://www.facebook.com/flyingoutmusic" target="_blank" rel="noopener noreferrer"><img className="socialmedia" src={fblogo} alt="Facebook Logo" /></a>

        <a href="https://open.spotify.com/user/flyingout?si=a7DM7PBuTFyLnu7FwZSnWg" target="_blank" rel="noopener noreferrer"><img className="socialmedia" src={spotlogo} alt="Spotify Logo" /></a>
      </div>
